...
import com.example.before.config.properties.FcmProperties;
...
public class FcmClient {
    ...
    public void send(FcmMulticastMessage fcmMulticastMessage) {
        ...
        multicastMessages.forEach(it -> {
            FirebaseMessaging.getInstance(FirebaseApp.getInstance()).sendEachForMulticastAsync(it);
        });
    }
