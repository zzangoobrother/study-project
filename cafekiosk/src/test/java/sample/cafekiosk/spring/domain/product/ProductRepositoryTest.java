...
class ProductRepositoryTest extends IntegrationTestSupport {
    ...
    @DisplayName("상품번호 리스트로 상품들 조회한다.")
    @Test
    ...
    void findLatestProductNumber() {
        // given
        String productNumber = "003";

        Product product1 = createProduct("001", ProductType.HANDMADE, ProductSellingStatus.SELLING, "아메리카노", 4000);
        Product product2 = createProduct("002", ProductType.HANDMADE, ProductSellingStatus.HOLD, "카페라떼", 4500);
        Product product3 = createProduct(productNumber, ProductType.HANDMADE, ProductSellingStatus.STOP_SELLING, "팥빙수", 7000);
        ...
        // then
        assertThat(latestProductNumber).isEqualTo(productNumber);
    }
